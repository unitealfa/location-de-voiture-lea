const defaultContent = {
  ...
  adminAceulle: {
    ...
    description:
      "Gardez une vue directe sur les demandes a traiter, les reservations confirmees, les visites du site et les tendances de location.",
    ...
    chartSiteVisitsTitle: "Visites du site sur 7 jours",
    ...
    lineVisitsTitle: "Evolution des visites",
